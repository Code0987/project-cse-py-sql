from bakery_ordering_system import app, models, forms, models
from bakery_ordering_system.models import session as dbsession, Customer
from bakery_ordering_system.forms import SignupForm, DeliveryRecipientForm
...
# <<<<<<< HEAD
      ...
      try:
        ...
        user = User.create(
              email=form.email.data,
              user_id=hash(str(uuid.uuid1())) % 1000000,
              name=form.name.data,
              )
